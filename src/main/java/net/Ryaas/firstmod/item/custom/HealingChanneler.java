...
public class HealingChanneler extends Item {
    public HealingChanneler(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level world, Player player, InteractionHand hand) {
        if (!world.isClientSide) { // Ensure this only runs on the server side
            ...
            if (!playerData.contains("AbilitySet") || playerData.getInt("AbilitySet") != 2) {
                ...
                playerData.putInt("AbilitySet", 2);
                ...
                if (!playerData.contains("AbilitySet")) {
                    ...
                    player.sendSystemMessage(Component.literal("Ability Set updated to 2."));
                }
                ...
                player.sendSystemMessage(Component.literal("Your Ability Set is already set to 2."));
            }
        }
